...
excludes='\.git|\.coverage|\.cache|tmp|env|deps|_build|\.elixir_ls|cover|target|\.vscode|.*\.pdf'
cmd=""
...
Usage: $(basename $0) [OPTIONS] COMMAND
  ...
  -b, --base PATH         Watch for changes on given PATH. Default is $(pwd).
...
function execute {
    ...
    maybe_echo "Watching: $yellow$base$reset"
